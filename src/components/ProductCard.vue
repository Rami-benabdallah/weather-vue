<template>
  <div
      class="relative mb-6 w-1/2 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    ...
    <div class="mt-4 px-5 pb-5">
      ...
      <a  @click="addToBag(product.title)"
          href="#"
